...
<body>
	...
	<form action="loginprocess.jsp" id="loginform" method="post">
		<input type="text" id="id" name="id" placeholder="아이디를 입력하세요" required="required"/><br/>
		<input type="password" id="pw" name="pw" placeholder="비밀번호를 입력하세요" required="required"/><br/>
	</form>
	<a href="#"><img src="./images/login.png" id="login" width="180" height="100"/></a>
</body>
<script>
